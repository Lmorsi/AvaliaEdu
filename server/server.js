...
const generateAnswerSheet = async (finalData) => {
  ...
  let answerSheetHTML = `
    <div style="padding: 12mm 12mm 10mm 12mm; margin-top: 5mm; page-break-inside: avoid;">
      ...
      <div style="position: relative; display: flex; gap: 4mm; justify-content: space-between; padding: 5mm;">
      ...
      validAlternatives.forEach((_, altIndex) => {
        ...
        questionHTML += `
          <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5mm;">
            ...
            <div class="bubble" style="width: 4mm; height: 4mm; border: 1.9px solid #333; border-radius: 50%; background: white;"></div>
          </div>
        `;
      });
